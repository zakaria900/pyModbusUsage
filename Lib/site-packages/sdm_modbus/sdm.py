...
class SDM54_2T(SDM):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.registers = {
            # ======================
            # Registres INPUT (mesures) - Trois phases
            # ======================
            "l1_voltage": (
                0x0000, 2, 
                meter.registerType.INPUT, 
                meter.registerDataType.FLOAT32, 
                float, "L1 Voltage", "V", 1, 1
            ),
            "l2_voltage": (
                0x0002, 2, 
                meter.registerType.INPUT, 
                meter.registerDataType.FLOAT32, 
                float, "L2 Voltage", "V", 1, 1
            ),
            "l3_voltage": (
                0x0004, 2, 
                meter.registerType.INPUT, 
                meter.registerDataType.FLOAT32, 
                float, "L3 Voltage", "V", 1, 1
            ),
            "l1_current": (
                0x0006, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L1 Current", "A", 1, 1
            ),
            "l2_current": (
                0x0008, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L2 Current", "A", 1, 1
            ),
            "l3_current": (
                0x000A, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L3 Current", "A", 1, 1
            ),
            "l1_power_active": (
                0x000C, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L1 Active Power", "W", 1, 1
            ),
            "l2_power_active": (
                0x000E, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L2 Active Power", "W", 1, 1
            ),
            "l3_power_active": (
                0x0010, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L3 Active Power", "W", 1, 1
            ),
            "total_power_active": (
                0x0012, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Total Active Power", "W", 1, 1
            ),
            "l1_power_reactive": (
                0x0014, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L1 Reactive Power", "VAr", 1, 1
            ),
            "l2_power_reactive": (
                0x0016, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L2 Reactive Power", "VAr", 1, 1
            ),
            "l3_power_reactive": (
                0x0018, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L3 Reactive Power", "VAr", 1, 1
            ),
            "total_power_reactive": (
                0x001A, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Total Reactive Power", "VAr", 1, 1
            ),
            "l1_power_apparent": (
                0x001C, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L1 Apparent Power", "VA", 1, 1
            ),
            "l2_power_apparent": (
                0x001E, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L2 Apparent Power", "VA", 1, 1
            ),
            "l3_power_apparent": (
                0x0020, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L3 Apparent Power", "VA", 1, 1
            ),
            "total_power_apparent": (
                0x0022, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Total Apparent Power", "VA", 1, 1
            ),
            "l1_power_factor": (
                0x0024, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L1 Power Factor", "", 1, 1
            ),
            "l2_power_factor": (
                0x0026, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L2 Power Factor", "", 1, 1
            ),
            "l3_power_factor": (
                0x0028, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L3 Power Factor", "", 1, 1
            ),
            "total_power_factor": (
                0x002A, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Total Power Factor", "", 1, 1
            ),
            "frequency": (
                0x002C, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Frequency", "Hz", 1, 1
            ),

            # ---------------------------
            # Registres d'énergie à double tarif
            # ---------------------------
            # Tarif 1
            "import_energy_active_t1": (
                0x002E, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Import Active Energy (Tariff 1)", "kWh", 1, 1
            ),
            "export_energy_active_t1": (
                0x0030, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Export Active Energy (Tariff 1)", "kWh", 1, 1
            ),
            # Tarif 2
            "import_energy_active_t2": (
                0x0032, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Import Active Energy (Tariff 2)", "kWh", 1, 1
            ),
            "export_energy_active_t2": (
                0x0034, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Export Active Energy (Tariff 2)", "kWh", 1, 1
            ),
            "total_energy_active": (
                0x0036, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Total Active Energy", "kWh", 1, 1
            ),
            # Énergie réactive (si mesurée)
            "import_energy_reactive_t1": (
                0x0038, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Import Reactive Energy (Tariff 1)", "kVArh", 1, 1
            ),
            "export_energy_reactive_t1": (
                0x003A, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Export Reactive Energy (Tariff 1)", "kVArh", 1, 1
            ),
            "import_energy_reactive_t2": (
                0x003C, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Import Reactive Energy (Tariff 2)", "kVArh", 1, 1
            ),
            "export_energy_reactive_t2": (
                0x003E, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Export Reactive Energy (Tariff 2)", "kVArh", 1, 1
            ),
            "total_energy_reactive": (
                0x0040, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Total Reactive Energy", "kVArh", 1, 1
            ),

            # ======================
            # Registres supplémentaires (exemple de mesures supplémentaires)
            # ======================
            "l1_line_to_line_voltage": (
                0x0042, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L1-L2 Voltage", "V", 1, 1
            ),
            "l2_line_to_line_voltage": (
                0x0044, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L2-L3 Voltage", "V", 1, 1
            ),
            "l3_line_to_line_voltage": (
                0x0046, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L3-L1 Voltage", "V", 1, 1
            ),
            "l1_demand_power_active": (
                0x0048, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L1 Demand Active Power", "W", 1, 1
            ),
            "l2_demand_power_active": (
                0x004A, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L2 Demand Active Power", "W", 1, 1
            ),
            "l3_demand_power_active": (
                0x004C, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "L3 Demand Active Power", "W", 1, 1
            ),
            "total_demand_power_active": (
                0x004E, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Total Demand Active Power", "W", 1, 1
            ),
            "voltage_thd": (
                0x0050, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Voltage THD", "%", 1, 1
            ),
            "current_thd": (
                0x0052, 2,
                meter.registerType.INPUT,
                meter.registerDataType.FLOAT32,
                float, "Current THD", "%", 1, 1
            ),

            # ======================
            # Registres HOLDING (configuration et paramètres)
            # ======================
            "modbus_id": (
                0x0100, 1,
                meter.registerType.HOLDING,
                meter.registerDataType.UINT16,
                int, "Modbus ID", "", 1, 0
            ),
            "baud_rate": (
                0x0101, 1,
                meter.registerType.HOLDING,
                meter.registerDataType.UINT16,
                int, "Baud Rate", "Bd", 1, 0
            ),
            "parity": (
                0x0102, 1,
                meter.registerType.HOLDING,
                meter.registerDataType.UINT16,
                int, "Parity", "", 1, 0   # Exemple: 0=None, 1=Even, 2=Odd
            ),
            "ct_ratio": (
                0x0103, 1,
                meter.registerType.HOLDING,
            ...
            "pulse_constant": (
                ...
                meter.registerType.HOLDING,
                meter.registerDataType.FLOAT32,
                float, "Pulse Constant", "imp/kWh", 1, 1
            ),
            "tariff_switch_time": (
                0x0107, 1,
                meter.registerType.HOLDING,
                meter.registerDataType.UINT16,
                int, "Tariff Switch Time", "min", 1, 0
            ),
            "voltage_calibration": (
                0x0108, 1,
                meter.registerType.HOLDING,
                meter.registerDataType.FLOAT32,
                float, "Voltage Calibration", "V", 1, 1
            ),
            "current_calibration": (
                0x0109, 1,
                meter.registerType.HOLDING,
                meter.registerDataType.FLOAT32,
                float, "Current Calibration", "A", 1, 1
            ),
            "pulse_output_delay": (
                0x010A, 1,
                meter.registerType.HOLDING,
                meter.registerDataType.UINT16,
                int, "Pulse Output Delay", "ms", 1, 0
            ),
            "pulse_output_width": (
                0x010B, 1,
                meter.registerType.HOLDING,
                meter.registerDataType.UINT16,
                int, "Pulse Output Width", "ms", 1, 0
            ),
            "pulse_output_config": (
                0x010C, 1,
                meter.registerType.HOLDING,
                meter.registerDataType.UINT16,
                int, "Pulse Output Config", "", 1, 0
            ),
            "double_tariff_config": (
                0x010D, 1,
                meter.registerType.HOLDING,
                meter.registerDataType.UINT16,
                int, "Double Tariff Config", "", 1, 0
            ),
            "firmware_version": (
                0x0120, 2,
                meter.registerType.HOLDING,
                meter.registerDataType.FLOAT32,
                float, "Firmware Version", "", 1, 1
            ),
        }
